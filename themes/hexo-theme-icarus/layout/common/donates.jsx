                    ...
                    <div class="buttons is-centered">
                        <div class="likecoin-embed likecoin-button">
                            ...
                            <iframe
                                scrolling="no"
                                frameborder="0"
                                src="https://button.like.co/in/embed/showwell0120/button?referrer=<%- encodeURIComponent(post.permalink) %>"
                            ></iframe>
                        </div>
                        {donates.map((service) => {
                            ...
                            if (typeof type === 'string') {
                                try {
                                    ...
                                    logger.w(
                                        `Icarus cannot load donate button "${type}"`
                                    );
                                }
                            }
                            return null;
